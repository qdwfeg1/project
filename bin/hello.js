...
${chalk.yellow("npm run dev")} to start a development environment at ${chalk.green(
  "localhost:8000",
)}

or

${chalk.yellow("npm run build")} to create a production ready static site in ${chalk.green(
  "./public",
)}
